-- Fix the copyright images cleanup trigger function
-- This replaces the non-existent storage.delete_object() with direct DELETE statements

-- Drop existing triggers and function
DROP TRIGGER IF EXISTS trigger_cleanup_copyright_images_on_update ON pending_products;
DROP TRIGGER IF EXISTS trigger_cleanup_copyright_images_on_delete ON pending_products;
DROP FUNCTION IF EXISTS cleanup_copyright_images();

-- Recreate the function with the correct DELETE syntax
